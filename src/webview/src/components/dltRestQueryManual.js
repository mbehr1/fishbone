    ...
    <Dialog fullScreen open={props.open} onClose={handleClose}>
      ...
      <DialogContent dividers>
        <Typography variant='h5' gutterBottom>
          DLT-Logs rest query needs to be URI decoded (done automatically here). After commands separated by &amp; a new line has to follow.
          Details see <Link href='https://mbehr1.github.io/fishbone/docs/badges'>docs</Link>
        </Typography>
        <TextField
          name='DLT rest query'
          margin='dense'
          id={'description-field-rest-query'}
        ...
        {error.length > 0 && (
          <div>
            ...
            <TextField
              error
              label='Error:'
              name='DLT rest query error'
              margin='dense'
              id={'description-field-rest-query-error'}
              InputLabelProps={{ shrink: true }}
              fullWidth
              multiline
              value={error}
